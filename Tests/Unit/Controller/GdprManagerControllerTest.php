...
{
    /**
     * @var \GdprExtensionsCom\GdprExtensionsComGrl\Controller\GdprManagerController|MockObject|AccessibleObjectInterface
     */
    protected $subject;
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder($this->buildAccessibleProxy(\GdprExtensionsCom\GdprExtensionsComGrl\Controller\GdprManagerController::class))
    ...
    public function listActionFetchesAllGdprManagersFromRepositoryAndAssignsThemToView(): void
    {
        ...
        $gdprManagerRepository = $this->getMockBuilder(\GdprExtensionsCom\GdprExtensionsComGrl\Domain\Repository\GdprManagerRepository::class)
            ->onlyMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $gdprManager = new \GdprExtensionsCom\GdprExtensionsComGrl\Domain\Model\GdprManager();
