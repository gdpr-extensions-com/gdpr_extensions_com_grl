...
$fields = [
    ...
    'gdpr_business_locations_list' => [
        'config' => [
            ...
            'itemsProcFunc' => 'GdprExtensionsCom\GdprExtensionsComGrl\Utility\ProcesslistItems->getLocationsforRoodPid',
        ],
    ],
...
$GLOBALS['TCA']['tt_content']['types']['gdprextensionscomgrl_googlereviewlist'] = [
    'showitem' => '
