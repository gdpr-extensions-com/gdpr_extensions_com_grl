...
namespace GdprExtensionsCom\GdprExtensionsComGrl\Utility;
        ...
        foreach ($multilocationQBResult as $location) {
            try {
                ...
                if ($apiKey) {
                    ...
                    $reviewsToolUrl = (is_null($BaseURL) ? 'https://dashboard.gdpr-extensions.com/': $BaseURL).'review/api/'.$location['dashboard_api_key'].'/reviews-list.json';
