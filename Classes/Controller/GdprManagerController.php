...
namespace GdprExtensionsCom\GdprExtensionsComGrl\Controller;


use GdprExtensionsCom\GdprExtensionsComGrl\Domain\Model\MapLocation;
...
class GdprManagerController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController
{
     ...
     *
     * @var \GdprExtensionsCom\GdprExtensionsComGrl\Domain\Repository\GdprManagerRepository
     */
    ...
    public function listAction(): \Psr\Http\Message\ResponseInterface
    {
        ...
        $reviewListData = $this->gdprManagerRepository->findByExtension_key('gdpr_extensions_com_grl')->toArray();
        return $this->redirect('edit',null,null,['gdprManager' => $reviewListData[0]]);
     ...
     * action show
     *
     * @param \GdprExtensionsCom\GdprExtensionsComGrl\Domain\Model\GdprManager $gdprManager
     * @return \Psr\Http\Message\ResponseInterface
     */
    public function showAction(\GdprExtensionsCom\GdprExtensionsComGrl\Domain\Model\GdprManager $gdprManager): \Psr\Http\Message\ResponseInterface
    {
     ...
     * action create
     *
     * @param \GdprExtensionsCom\GdprExtensionsComGrl\Domain\Model\GdprManager $newGdprManager
     */
    public function createAction(\GdprExtensionsCom\GdprExtensionsComGrl\Domain\Model\GdprManager $newGdprManager)
    {
     ...
     * @return \Psr\Http\Message\ResponseInterface
     */
    public function editAction(\GdprExtensionsCom\GdprExtensionsComGrl\Domain\Model\GdprManager $gdprManager): \Psr\Http\Message\ResponseInterface
    {
        ...
        if(strpos($gdprManager->getExtensionKey(), 'gdpr_extensions_com_grl') !== false){
     ...
     * @return \Psr\Http\Message\ResponseInterface
     */
    public function updateAction(\GdprExtensionsCom\GdprExtensionsComGrl\Domain\Model\GdprManager $gdprManager) : \Psr\Http\Message\ResponseInterface
    {
        if($this->request->hasArgument('tx_GdprExtensionsComGrl_web_GdprExtensionsComGrlgdprmanager')){
            $locationsData = $this->request->getArgument('tx_GdprExtensionsComGrl_web_GdprExtensionsComGrlgdprmanager')['locations'];
        }
     ...
     * @param \GdprExtensionsCom\GdprExtensionsComGrl\Domain\Model\GdprManager $gdprManager
     */
    public function deleteAction(\GdprExtensionsCom\GdprExtensionsComGrl\Domain\Model\GdprManager $gdprManager)
    {
...
//            }
    ...
    /**
     * @param \GdprExtensionsCom\GdprExtensionsComGrl\Domain\Repository\GdprManagerRepository $gdprManagerRepository
     */
    public function injectGdprManagerRepository(\GdprExtensionsCom\GdprExtensionsComGrl\Domain\Repository\GdprManagerRepository $gdprManagerRepository)
    {
