...
use GdprExtensionsCom\GdprExtensionsComGrl\Utility\Helper;
...
/**
 * googlereviewlistController
 */
class GdprGoogleReviewListController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController
{
    ...
    public function showReviewsAction()
    {
        ...
        $cache = $cacheManager->getCache('GdprExtensionsComGrl');
